        ...
        <div>
            ...
            <div className={styles.main}>
                <section className={styles.hero}>
                    <h1>Biz haqimizda</h1>
                    <p>
                    <span className={styles.span}>"Fluent Study"</span> — bu innovatsion va sifatli ta'limni taqdim etuvchi zamonaviy o‘quv markazi. Bizning maqsadimiz har bir o‘quvchiga mustaqil o‘rganish va kelajakka ishonch bilan qadam qo‘yish imkoniyatini yaratishdir.
                    </p>
                </section>
                ...
                <section className={styles.cta}>
                    ...
                    <h2><span className={styles.span}>"Fluent Study"</span> bilan o'z kelajagingni qur !</h2>
                </section>
            </div>
            <Footer></Footer>
        </div>
